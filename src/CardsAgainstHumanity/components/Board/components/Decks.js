...
export const BlackDeck = ({ deck }) => (
  <div className={`w-64 h-64 bg-gray-600 rounded shadow-md flex items-center`}>
...
export const ActionableBlackDeck = ({ onClick }) => (
  <button
    className={`w-64 h-64 bg-gray-900 hover:bg-black text-gray-300 hover:text-white rounded-lg shadow-md text-xl`}
    onClick={onClick}
  >
